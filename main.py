...
@app.get("/user/{user_id}/additional-transaction-information-category", tags=["Additional Transaction Info"])
def get_additional_transaction_information_category(user_id: int):
    ...
    url = f"https://public-api.sandbox.bunq.com/v1/user/{end_user_id}/additional-transaction-information-category"
...
# USER EVENTS
@app.get("/user/{user_id}/event", tags=["Events"])
def get_events(user_id: int):
    ...
    url = f"https://public-api.sandbox.bunq.com/v1/user/{api_key_user_id}/event"
    response = requests.get(url, headers=headers)
    try:
        return response.json()
    except Exception:
...
@app.get("/user/{user_id}/event/{item_id}", tags=["Events"])
def get_event_by_id(user_id: int, item_id: int):
    ...
    url = f"https://public-api.sandbox.bunq.com/v1/user/{api_key_user_id}/event/{item_id}"
    response = requests.get(url, headers=headers)
    try:
        return response.json()
    except Exception:
...
@app.get("/user/{user_id}/mastercard_action/", tags=["Mastercard Action"])
def list_mastercard_action(user_id: int, monetary_account_id):
    ...
    url = f"https://public-api.sandbox.bunq.com/v1/user/{api_key_user_id}/monetary-account/{monetary_account_id}/mastercard-action/"
    response = requests.get(url, headers=headers)
    try:
        return response.json()
    except Exception:
...
@app.get("/user/{user_id}/mastercard_action/{item_id}", tags=["Mastercard Action"])
def get_mastercard_action(user_id: int, monetary_account_id, item_id: int):
    ...
    url = f"https://public-api.sandbox.bunq.com/v1/user/{api_key_user_id}/monetary-account/{monetary_account_id}/mastercard-action/{item_id}"
    response = requests.get(url, headers=headers)
    try:
        return response.json()
    except Exception:
